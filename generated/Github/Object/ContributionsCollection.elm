...
issueContributions fillInOptionals object_ =
    let
        filledInOptionals =
            fillInOptionals { after = Absent, before = Absent, excludeFirst = Absent, excludePopular = Absent, first = Absent, last = Absent, orderBy = Absent }

        optionalArgs =
            [ Argument.optional "after" filledInOptionals.after Encode.string, Argument.optional "before" filledInOptionals.before Encode.string, Argument.optional "excludeFirst" filledInOptionals.excludeFirst Encode.bool, Argument.optional "excludePopular" filledInOptionals.excludePopular Encode.bool, Argument.optional "first" filledInOptionals.first Encode.int, Argument.optional "last" filledInOptionals.last Encode.int, Argument.optional "orderBy" filledInOptionals.orderBy Github.InputObject.encodeContributionOrder ]
                |> List.filterMap identity
    in
...
issueContributionsByRepository fillInOptionals object_ =
    let
        filledInOptionals =
            fillInOptionals { excludeFirst = Absent, excludePopular = Absent, maxRepositories = Absent }

        optionalArgs =
            [ Argument.optional "excludeFirst" filledInOptionals.excludeFirst Encode.bool, Argument.optional "excludePopular" filledInOptionals.excludePopular Encode.bool, Argument.optional "maxRepositories" filledInOptionals.maxRepositories Encode.int ]
                |> List.filterMap identity
    in
...
repositoryContributions fillInOptionals object_ =
    let
        filledInOptionals =
            fillInOptionals { after = Absent, before = Absent, excludeFirst = Absent, first = Absent, last = Absent, orderBy = Absent }

        optionalArgs =
            [ Argument.optional "after" filledInOptionals.after Encode.string, Argument.optional "before" filledInOptionals.before Encode.string, Argument.optional "excludeFirst" filledInOptionals.excludeFirst Encode.bool, Argument.optional "first" filledInOptionals.first Encode.int, Argument.optional "last" filledInOptionals.last Encode.int, Argument.optional "orderBy" filledInOptionals.orderBy Github.InputObject.encodeContributionOrder ]
                |> List.filterMap identity
    in
